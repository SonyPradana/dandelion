      ...
      <div class="checkbox-group">
        ...
        <div class="checkbox-item">
          ...
          <label for="agree-checkbox"
            >Saya telah membaca dan menyetujui syarat dan ketentuan.</label
          >
        </div>
      </div>
    </div>
...
function ConfigTab() {
  ...
  if (!config || !form)
    return html`<div class="header"><h1>Konfigurasi</h1></div>
      <div class="content">Memuat...</div>`;
      ...
      <details class="config-group" open>
        ...
        <div class="form-group">
          ...
          <input
            ...
            value=${form.fsUrl}
            onInput=${(e) => update('fsUrl', e.target.value)}
          />
        </div>
        <div class="form-group">
          <div class="checkbox-item">
      ...
      <details class="config-group" open>
        ...
        <div class="form-group">
          ...
          <input
            ...
            value=${form.ncUrl}
            onInput=${(e) => update('ncUrl', e.target.value)}
          />
        </div>
        <div class="form-group">
        ...
        <div class="delay-settings-grid">
          <div class="form-group-sm">
            ...
            <input
              ...
              min="500"
              max="10000"
              value=${form.ncAutomationDelay}
              onInput=${(e) => update('ncAutomationDelay', e.target.value)}
            />
          </div>
          <div class="form-group-sm">
            ...
            <input
              ...
              min="100"
              max="5000"
              value=${form.ncItemDelay}
              onInput=${(e) => update('ncItemDelay', e.target.value)}
            />
          </div>
          <div class="form-group-sm">
            ...
            <input
              ...
              min="500"
              max="15000"
              value=${form.ncReloadDelay}
              onInput=${(e) => update('ncReloadDelay', e.target.value)}
            />
          </div>
        </div>
      </details>
      <details class="config-group">
        ...
        <div class="form-group">
          ...
          <input
            ...
            value=${form.skUrl}
            onInput=${(e) => update('skUrl', e.target.value)}
          />
        </div>
      </details>
      <button id="save-config-btn" class="btn" onClick=${handleSave}>
  ...
  return html`
    ...
    <div class="content" id="produktifitas-content">
      ...
      <div class="prod-progress">
        ...
        <div class="label-row">
          <span>${periodTotal.toLocaleString()} / ${MONTHLY_TARGET.toLocaleString()} poin</span>
        </div>
...
function PopupApp() {
  ...
  return html`
    <div class="container">
      <div class="tab-nav">
        <button
          class="tab-button${activeTab === 'agreement' ? ' active' : ''}"
        ...
        <button
          class="tab-button${activeTab === 'produktifitas' ? ' active' : ''}"
          onClick=${() => setActiveTab('produktifitas')}
        >
          Produktivitas
        </button>
      </div>
      <div id="agreement" class="tab-content${activeTab === 'agreement' ? ' active' : ''}">
        <${AgreementTab} />
      </div>
      <div id="config" class="tab-content${activeTab === 'config' ? ' active' : ''}">
        <${ConfigTab} />
      </div>

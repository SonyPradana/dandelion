...
import { setFlashData, clearFlashData } from './flashSession';
...
// ─── kv helpers ───────────────────────────────────────────────────
function addKvRow(container, key, value, onRowChange) {
...
function rebuildKvRows(container, data, onRowChange) {
  container.innerHTML = '';

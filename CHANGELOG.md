...
- Make section 4 in registration form resumable in-session (#122)
- Keep countdown text and progress bar in sync (#121)
- Trigger service completion when Zero Mode finishes on an uncheck item (#120)
...
- Improve performance by using timeout instead of setInterval (#74)

### Added

- Added confirm bottom to complate service after all form are done (#79)

## [1.5.1] - 2026-06-10

### Fixed

- Add expiry guard for flashing data (#76)
